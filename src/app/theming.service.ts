...
export class ThemingService {
	...
	themes = {
		...
		aquila: {
			...
			'--bastionFactionFilter':	'hue-rotate(-153deg) saturate(0.1) brightness(1.8)',
		},
		dugo: {
			...
			'--fontHeader'					: 'Roboto, Helvetica, sans-serif',
			'--fontTiles'						: 'Roboto, Helvetica, sans-serif',
			'--imgFactionFilter'		: 'saturate(25%) sepia(50%) drop-shadow(0px 0px 2px #B31B1B) drop-shadow(2px 2px 1px #65000B)',
		...
		ekanesh: {
			...
			'--bastionFactionFilter':	'hue-rotate(-255deg) saturate(0.3) brightness(1.4)',
		},
		pendzal: {
			...
			'--fontHeader'					: 'Roboto, Helvetica, sans-serif',
			'--fontTiles'						: 'Roboto, Helvetica, sans-serif',
			'--bastionFactionFilter':	'hue-rotate(-315deg) saturate(1.75) brightness(3.3)',
		},
		sona: {
			...
			'--fontHeader'					: 'Roboto, Helvetica, sans-serif',
			'--fontTiles'						: 'Roboto, Helvetica, sans-serif',
			'--imgFactionFilter'		: 'hue-rotate(120deg) sepia(0.85) saturate(1.65) brightness(1.4) drop-shadow(2px 1px 0px #D4AF37)',
			'--bastionFactionFilter':	'hue-rotate(60deg) saturate(0.65) brightness(2.5)',
		},
		seventh: {
			...
			'--bastionFactionFilter':	'grayscale(1) brightness(5) drop-shadow(0px 0px 7px #00A550)',
		},
	};
	selectedTheme:any;
